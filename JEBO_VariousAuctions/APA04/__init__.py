...
class C(BaseConstants):
    NAME_IN_URL = 'all-pay_auction(APA)'
    PLAYERS_PER_GROUP = 7
    NUM_ROUNDS = 2
    ENDOWMENT = 5000
        ...
        for g1 in G1:
            if g1.is_winner:
                if Seller1.SellerProductQuality == 'HIGH':
                    g1.profit = C.HighQuality_v - g1.BuyerBid
                    Seller1.profit = g1.BuyerBid
                else:
                    g1.profit = C.LowQuality_v - g1.BuyerBid
                    Seller1.profit = g1.BuyerBid
            else:
                g1.profit = -g1.BuyerBid
        
        for g2 in G2:
            if g2.is_winner:
                if Seller2.SellerProductQuality == 'HIGH':
                    g2.profit = C.HighQuality_v - g2.BuyerBid
                    Seller2.profit = g2.BuyerBid
                else:
                    g2.profit = C.LowQuality_v - g2.BuyerBid
                    Seller2.profit = g2.BuyerBid
            else:
                g2.profit = -g2.BuyerBid
...
page_sequence = [Introduction,SellerMessage,SellerDecisionWaitPage,SellerReservation,SellerDecisionWaitPage,BuyerDecision2Bid,BuyerDecisionWaitPage,G1Bid,G2Bid,BidWaiting,BuyersResults,SellersResults,G3Bid,RoundEndWaiting,FinalPage]
